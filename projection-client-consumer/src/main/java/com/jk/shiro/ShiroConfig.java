...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/js1/**", "anon");
        filterChainDefinitionMap.put("/css/**", "anon");
        filterChainDefinitionMap.put("/https/**", "anon");
        filterChainDefinitionMap.put("/tomain", "anon");
        filterChainDefinitionMap.put("/tovideo", "anon");
        filterChainDefinitionMap.put("/tovideo2", "anon");
        filterChainDefinitionMap.put("/index", "anon");
        filterChainDefinitionMap.put("/video/**", "anon");
        filterChainDefinitionMap.put("/tofufei", "anon");
        filterChainDefinitionMap.put("/fufei", "anon");
        filterChainDefinitionMap.put("/findUser", "anon");
        filterChainDefinitionMap.put("/js2/**", "anon");
        ...
        filterChainDefinitionMap.put("/toRegister", "anon");//去注册页面
        filterChainDefinitionMap.put("/toRegister2", "anon");
        filterChainDefinitionMap.put("/register", "anon");
        filterChainDefinitionMap.put("/toEditPwd", "anon");//忘记密码
        filterChainDefinitionMap.put("/editPwd", "anon");
        filterChainDefinitionMap.put("/getCode", "anon");
        filterChainDefinitionMap.put("/phoneLogin", "anon");
        filterChainDefinitionMap.put("/goProtocol", "anon");
        filterChainDefinitionMap.put("/regPhoneNumber", "anon");

        filterChainDefinitionMap.put("/advertising/**", "anon");
        filterChainDefinitionMap.put("/pinglun/**", "anon");
